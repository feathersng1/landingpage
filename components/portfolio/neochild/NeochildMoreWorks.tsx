...
export function NeochildMoreWorks() {
  return (
    <motion.section
      ...
      <div className="max-w-[1440px] mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-6 w-full">
          ...
          <motion.div variants={itemVariants} className="flex flex-col group cursor-pointer">
            <div className="relative w-full aspect-[4/3] bg-[#008387] rounded-[16px] overflow-hidden mb-6 flex items-center justify-center p-6 sm:p-12 md:p-20">
          ...
          {/* Project 2: Notrify */}
          <motion.div variants={itemVariants} className="flex flex-col group cursor-pointer">
            <div className="relative w-full aspect-[4/3] bg-[#F2F2F3] rounded-[16px] overflow-hidden mb-6 flex items-center justify-center p-6 sm:p-12 md:p-20">
              <div className="relative w-full h-full bg-white rounded-[12px] overflow-hidden flex items-center justify-center border border-neutral-100">
                <div className="text-neutral-400 font-onest uppercase tracking-tighter text-[14px]">[ NOTRIFY PREVIEW ]</div>
              </div>
            </div>
            <div className="flex flex-col space-y-1">
              <h3 className="font-onest text-[18px] md:text-[20px] font-medium text-[#141414]">Upcoming Project</h3>
