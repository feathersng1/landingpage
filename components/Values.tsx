    ...
    <div className="relative rounded-lg shrink-0" data-name="Button">
      ...
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-3 py-1 relative">
          <div className="font-['Onest:Medium',_sans-serif] leading-[0] relative shrink-0 text-[16px] text-left text-neutral-100 text-nowrap tracking-[-0.64px]">
...
function TeamTextSubcontainer() {
  return (
    ...
    >
      <Button />
      <div className="font-['Monarque:Regular',_sans-serif] leading-[0] max-w-[811.29px] not-italic relative shrink-0 text-[#ffffff] text-[0px] text-left tracking-[-3.2px] w-full lg:w-[811.29px]">
        <p className="leading-[60px] md:leading-[80px] text-[48px] md:text-[64px] lg:text-[80px]">
...
function ValueCard({ title, description }: { title: string; description: string }) {
  return (
    <div
      ...
      data-name="Team Text Subcontainer"
    >
      <div className="font-['Onest:Medium',_sans-serif] relative shrink-0 text-[24px] tracking-[-0.96px] w-[200px]">
        <p className="leading-[32px]" dangerouslySetInnerHTML={{ __html: title }} />
      </div>
      <div
        className="font-['Onest:Regular',_sans-serif] min-w-full relative shrink-0 text-[16px] tracking-[-0.64px]"
...
function TeamTextSubcontainer4() {
  return (
    ...
    >
      <ValueCard
        title={`Clarity, <span class="text-neutral-400">clear outcome</span>`}
        description="We cut through noise to help you focus—on what matters, what works, and what gets your brand seen and remembered."
      />
      <ValueCard
        title={`Analytical,<span class="text-neutral-400"> data-backed</span>`}
        description="Strategy isn't guesswork. We dig into the data, connect the dots, and design with insight so you grow with purpose."
      />
      <ValueCard
        title={`Reliable, <span class="text-neutral-400">always dependable</span>`}
        description="No flaking, no fluff. Just a team you can count on to deliver—on time, on point, and always in sync with your hustle."
      />
    </div>
  );
}
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center max-w-inherit overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2.5 items-center justify-center max-w-inherit px-0 py-20 relative w-full px-[0px] py-[108px]">
          <TeamTextContainer />
        </div>
      </div>
    </div>
...
export function Values() {
  return (
    <div className="bg-[#141414] relative shrink-0 w-full" data-name="section">
